...
local _minimum          = scaleform.Actor.property(thisActor, "Min")
local _min_width        = scaleform.Actor.property(thisActor, "MinWidth")
local _min_height       = scaleform.Actor.property(thisActor, "MinHeight")
local _maximum          = scaleform.Actor.property(thisActor, "Max")
local _max_width        = scaleform.Actor.property(thisActor, "MaxWidth")
local _max_height       = scaleform.Actor.property(thisActor, "MaxHeight")
...
local function _stretch_right(right_end, end_offset)
	...
	if _minimum and _min_width and _min_width ~= "MinWidth" and _min_height ~= "MinHeight" then
		if required_width < _min_width then required_width = _min_width end
	end

	if _maximum and _max_width and _max_width ~= "MaxWidth" and _max_height ~= "MaxHeight" then
		if required_width > _max_width then required_width = _max_width end
	end
...
local function _stretch_up(up_end, end_offset)
	...
	if _minimum and _min_height and _min_height ~= "MinHeight" and _min_width ~= "MinWidth" then
		if required_height < _min_height then required_height = _min_height end
	end

	if _maximum and _max_height and _max_height ~= "MaxHeight" and _max_width ~= "MaxWidth" then
		if required_height > _max_height then required_height = max_height end
	end
...
local function _stretch_down(down_end, end_offset)
	...
	if _maximum and _max_height and _max_height ~= "MaxHeight" and _max_width ~= "MaxWidth" then
		if required_height > _max_height then required_height = _max_height end
	end
